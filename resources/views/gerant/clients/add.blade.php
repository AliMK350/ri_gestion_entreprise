...
<div class="content-wrapper">
    ...
    </div><div class="card-footer"><button class="btn btn-primary">Enregistrer</button> <a href="{{ url('gerant/clients/list') }}" class="btn btn-default">Annuler</a></div></form></div></div></section>
</div>
@endsection
