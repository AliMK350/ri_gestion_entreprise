...
<div class="content-wrapper">
    ...
    <section class="content"><div class="container-fluid"><div class="card card-primary"><form method="post" action="{{ route($personnelUrlPrefix.'.absences.store') }}" enctype="multipart/form-data">@csrf<div class="card-body">
    ...
    </div><div class="card-footer"><button class="btn btn-primary">Enregistrer</button> <a href="{{ url($personnelUrlPrefix.'/absences') }}" class="btn btn-default">Annuler</a></div></form></div></div></section>
</div>
@endsection
