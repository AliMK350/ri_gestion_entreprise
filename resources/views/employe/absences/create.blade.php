...
<div class="content-wrapper">
    ...
    <section class="content"><div class="container-fluid"><div class="card card-primary"><form method="post" action="{{ route('employe.absences.store') }}">@csrf<div class="card-body">
