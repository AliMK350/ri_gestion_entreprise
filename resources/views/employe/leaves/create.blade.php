...
<div class="content-wrapper">
    ...
    <section class="content"><div class="container-fluid"><div class="card card-primary"><form method="POST" action="{{ route('employe.leaves.store') }}" enctype="multipart/form-data">@csrf<div class="card-body">
