...
<div class="content-wrapper">
    ...
    <section class="content"><div class="container-fluid"><div class="card card-primary"><form method="POST" action="{{ route($personnelUrlPrefix.'.leaves.store') }}" enctype="multipart/form-data">@csrf<div class="card-body">
        ...
        <div class="form-group"><label>Type *</label><select name="type" class="form-control"><option value="vacation">Congé payé</option><option value="sick">Maladie</option><option value="personal">Personnel</option><option value="other">Autre</option><option value="death">Décès</option><option value="marriage">Mariage</option></select></div>
    ...
    </div><div class="card-footer"><button class="btn btn-primary">Envoyer la demande</button> <a href="{{ url($personnelUrlPrefix.'/absences') }}" class="btn btn-default">Annuler</a></div></form></div></div></section>
</div>
@endsection
