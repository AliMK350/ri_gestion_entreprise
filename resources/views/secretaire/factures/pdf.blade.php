...
<table><tr><th>Description</th><th>Montant</th></tr><tr><td>{{ $invoice->details ?? 'Prestations' }}</td><td>{{ number_format($invoice->amount, 2) }} MAD</td></tr></table>
<p style="margin-top:30px"><strong>Total TTC:</strong> {{ number_format($invoice->amount, 2) }} MAD</p>
</body></html>
