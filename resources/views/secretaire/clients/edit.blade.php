...
<div class="content-wrapper">
    ...
    </div><div class="card-footer"><button class="btn btn-primary">Mettre à jour</button> <a href="{{ url('secretaire/clients/list') }}" class="btn btn-default">Annuler</a></div></form></div></div></section>
</div>
@endsection
