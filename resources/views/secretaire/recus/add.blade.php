...
<div class="content-wrapper">
    ...
    <section class="content"><div class="container-fluid"><div class="card card-primary"><form method="post">@csrf<div class="card-body">
        ...
        <div class="form-group"><label>Facture *</label><select name="invoice_id" class="form-control" required>@foreach($invoices as $f)<option value="{{ $f->id }}">{{ $f->reference }} — {{ $f->client->name ?? '' }} ({{ number_format($f->amount,2) }} €)</option>@endforeach</select></div>
