...
<table><tr><th>Description</th><th>Montant</th></tr><tr><td>{{ $quote->details ?? 'Prestations' }}</td><td>{{ number_format($quote->total_amount, 2) }} €</td></tr></table>
<p style="margin-top:30px"><strong>Total TTC:</strong> {{ number_format($quote->total_amount, 2) }} €</p>
</body></html>
