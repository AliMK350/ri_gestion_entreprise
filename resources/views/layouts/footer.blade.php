<footer class="main-footer" style="font-family: Montserrat, sans-serif; font-size: 0.78rem; color: #4A4A4A; background: #fff; border-top: 1px solid #D9EEF8; display: flex; align-items: center; justify-content: space-between; padding: 0.75rem 1.25rem;">
    <div>
        <strong style="color: #00ADEF;">Ri Communication</strong>
